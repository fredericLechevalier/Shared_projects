...
namespace RayTracer {
    namespace Primitives {
        class Cone : public IPrimitives {
            public:
                Cone();
                Cone(const Math::Point3d &point, double radius, double height, const Math::Vector3d &color, const Math::Vector3d &direction);
                ~Cone();
                bool hits(Ray &ray);
        ...
        class FactoryCone : public IFactoryPrimitives {
            public:
