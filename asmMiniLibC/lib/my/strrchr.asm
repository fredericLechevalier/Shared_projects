...
_strrchr:            ;char *strrchr(rdi = char *str, sil(aka 8bit rsi) = int c ) with rcx = int cptr, r9 = int temp_cptr
	ENTER 0, 0
...
_strrchr_EmptyC:
    ADD     rdi, rcx        ;get all chars after rdi[cptr]
...
_strrchr_return:
    ...
    ADD     rdi, r9                 ;else : get all chars after rdi[r9]
    MOV     rax, rdi                ;get ready to output str
    LEAVE
    RET